...
class ModbusMaster
{
    ...
    public string $client_port = "502";
    public $status;
    public int $timeout_sec = 5; // Timeout 5 sec
    public int $endianness = 0; // Endianness codding (little endian == 0, big endian == 1)
    public string $socket_protocol = "UDP"; // Socket protocol (TCP, UDP)
    ...
    function connect()
    {
        ...
        // Socket settings
        socket_set_option($this->sock, SOL_SOCKET, SO_SNDTIMEO, array('sec' => self::$timeout, 'usec' => 0));
        // Connect the socket
     ...
     */
    function readMultipleRegisters($unitId, $reference, $quantity, $connect = true)
    {
        static::throttle();
        $reference--;
     ...
     * @return bool Success flag
     */
    function writeMultipleRegister($unitId, $reference, $data, $dataTypes, $connect = true)
    {
        static::throttle();
        $reference--;
